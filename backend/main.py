...
def construct_league_table(season_df: pd.DataFrame) -> pd.DataFrame:
    ...
    Points system:
        - Win  (more normaltime goals)  â†’ 3 pts
        - Draw (equal normaltime goals) â†’ 1 pt each
        - Loss                          â†’ 0 pts
...
if __name__ == "__main__":
    print("=" * 60)
    print("  Backline v2  â€“  Season Scraper & League Table Builder")
    print("=" * 60)

    # â”€â”€ 1. Scrape season EPL 25/26 data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    print("\n[*] Starting match data scraping...")
    season_df = get_season_data()
    print(f"[âœ“] Completed scraping {len(season_df)} matches\n")

    # â”€â”€ 2. Build league table from match results â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ 3. Save both DataFrames to data/raw/ â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    print(f"\n[âœ“] Season data saved  â†’ {season_path}")
    print(f"[âœ“] League table saved â†’ {table_path}")
